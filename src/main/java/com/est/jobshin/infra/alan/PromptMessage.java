...
//			"백엔드 개발자 취업 준비에 필요한 기술면접 질문을 5개 뽑아두고 \"한 문제씩만\" 출력해줘. 매 실행마다 다양한 문제들을 출력해주고 문제 레벨은 총 3단계 중 해당 유저의 레벨에 맞춰 뽑아줘. 질문만 출력해주면 돼";
	...
	public static final String QUESTION_PROMPT =
			"백엔드 개발자 취업 준비에 필요한 기술면접 질문을 5개를 문제 생성마다 최대한 다양하게 출력해줘. 문제 레벨은 총 3단계 중 해당 유저의 레벨에 맞춰 뽑아줘. 형식은 질문마다 대괄호에 담아서";

	public static final String ANSWER_PROMPT = "기술면접 모범 답안만 알려줘";
